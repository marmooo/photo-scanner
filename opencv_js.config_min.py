...
imgproc = {'': ['threshold', 'approxPolyDP', 'adaptiveThreshold', 'Canny', 'cvtColor', 'contourArea', 'findContours', 'warpPerspective', 'drawContours', 'arcLength', 'getPerspectiveTransform', 'dilate', 'blur', 'medianBlur', 'resize']}
